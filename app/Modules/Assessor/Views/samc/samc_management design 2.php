                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-end">
                                                <div class="icon icon-shape bg-white shadow text-center rounded-circle">
                                                    <i class="fas fa-clipboard text-primary opacity-10"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card bg-gradient-success">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-end">
                                                <div class="icon icon-shape bg-white shadow text-center rounded-circle">
                                                    <i class="fas fa-check text-success opacity-10"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card bg-gradient-danger">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-end">
                                                <div class="icon icon-shape bg-white shadow text-center rounded-circle">
                                                    <i class="fas fa-times text-danger opacity-10"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="action-container justify-content-center">
                                                                ...
                                                                <?php if ($samc->samc_status == 'AWAITING_REVIEWER_REVIEW'): ?>
