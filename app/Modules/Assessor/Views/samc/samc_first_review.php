            ...
            <div class="assessment-form" id="assessment-form">
                ...
                <form method="post" id="samcReviewForm">
                    ...
                    <div class="assessment-section">
                        ...
                        <div class="assessment-item" data-item-id="0">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>Name of the SAMC</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the name of the samc is appropriate and meets standards"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[0]" value="accepted" <?= (isset($reviews_1->sr_samc_name_status) && $reviews_1->sr_samc_name_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[0]" value="not_accepted" <?= (isset($reviews_1->sr_samc_name_status) && $reviews_1->sr_samc_name_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="0" <?= (isset($reviews_1->sr_samc_name_status) && $reviews_1->sr_samc_name_status == 'decide_later') ? 'checked' : ''; ?>>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[0]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_samc_name) ? $reviews_1->sr_samc_name : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="1">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>MQF level/levels</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the mqf level/levels is appropriate and meets standards"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[1]" value="accepted" <?= (isset($reviews_1->sr_mqf_level_status) && $reviews_1->sr_mqf_level_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[1]" value="not_accepted" <?= (isset($reviews_1->sr_mqf_level_status) && $reviews_1->sr_mqf_level_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="1" <?= (isset($reviews_1->sr_mqf_level_status) && $reviews_1->sr_mqf_level_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[1]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_mqf_level) ? $reviews_1->sr_mqf_level : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="2">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>Duration (in hours)</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the duration (in hours) is appropriate and meets standards"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[2]" value="accepted" <?= (isset($reviews_1->sr_duration_hours_status) && $reviews_1->sr_duration_hours_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[2]" value="not_accepted" <?= (isset($reviews_1->sr_duration_hours_status) && $reviews_1->sr_duration_hours_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="2" <?= (isset($reviews_1->sr_duration_hours_status) && $reviews_1->sr_duration_hours_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[2]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_duration_hours) ? $reviews_1->sr_duration_hours : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="3">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>Method of Instruction and Learning</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the method of instruction and learning is appropriate and meets standards"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[3]" value="accepted" <?= (isset($reviews_1->sr_teaching_methods_status) && $reviews_1->sr_teaching_methods_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[3]" value="not_accepted" <?= (isset($reviews_1->sr_teaching_methods_status) && $reviews_1->sr_teaching_methods_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="3" <?= (isset($reviews_1->sr_teaching_methods_status) && $reviews_1->sr_teaching_methods_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[3]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_teaching_methods) ? $reviews_1->sr_teaching_methods : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="4">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>Academic Credits</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the academic credits is appropriate and meets standards"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[4]" value="accepted" <?= (isset($reviews_1->sr_academic_credits_status) && $reviews_1->sr_academic_credits_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[4]" value="not_accepted" <?= (isset($reviews_1->sr_academic_credits_status) && $reviews_1->sr_academic_credits_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="4" <?= (isset($reviews_1->sr_academic_credits_status) && $reviews_1->sr_academic_credits_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[4]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_academic_credits) ? $reviews_1->sr_academic_credits : '' ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="assessment-section">
                        ...
                        <div class="assessment-item" data-item-id="5">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>SAMC Synopsis</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the samc synopsis is well-defined and aligns with course objectives"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[5]" value="accepted" <?= (isset($reviews_1->sr_synopsis_status) && $reviews_1->sr_synopsis_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[5]" value="not_accepted" <?= (isset($reviews_1->sr_synopsis_status) && $reviews_1->sr_synopsis_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="5" <?= (isset($reviews_1->sr_synopsis_status) && $reviews_1->sr_synopsis_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[5]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_synopsis) ? $reviews_1->sr_synopsis : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="6">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>SAMC Intended Learning Outcomes</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the samc intended learning outcomes is well-defined and aligns with course objectives"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[6]" value="accepted" <?= (isset($reviews_1->sr_intended_learning_outcomes_status) && $reviews_1->sr_intended_learning_outcomes_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[6]" value="not_accepted" <?= (isset($reviews_1->sr_intended_learning_outcomes_status) && $reviews_1->sr_intended_learning_outcomes_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="6" <?= (isset($reviews_1->sr_intended_learning_outcomes_status) && $reviews_1->sr_intended_learning_outcomes_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[6]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_intended_learning_outcomes) ? $reviews_1->sr_intended_learning_outcomes : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="7">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                    <span>Course Content Outline</span>
                                    <i class="fas fa-info-circle tooltip-icon" title="Evaluate if the course content outline is well-defined and aligns with course objectives"></i>
                                </div>
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[7]" value="accepted" <?= (isset($reviews_1->sr_content_outline_status) && $reviews_1->sr_content_outline_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[7]" value="not_accepted" <?= (isset($reviews_1->sr_content_outline_status) && $reviews_1->sr_content_outline_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="7" <?= (isset($reviews_1->sr_content_outline_status) && $reviews_1->sr_content_outline_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="assessment-remarks">
                                <textarea name="remarks[7]" placeholder="Add your remarks or suggestions here..." class="form-control"><?= isset($reviews_1->sr_content_outline) ? $reviews_1->sr_content_outline : '' ?></textarea>
                            </div>
                        </div>

                        <div class="assessment-item" data-item-id="8">
                            <div class="assessment-item-header">
                                <div class="assessment-item-title">
                                ...
                                <div class="assessment-options">
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[8]" value="accepted" <?= (isset($reviews_1->sr_assessment_status) && $reviews_1->sr_assessment_status == 'accepted') ? 'checked' : ''; ?> required>
                                            <span>Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-radio">
                                            <input type="radio" name="status[8]" value="not_accepted" <?= (isset($reviews_1->sr_assessment_status) && $reviews_1->sr_assessment_status == 'not_accepted') ? 'checked' : ''; ?> required>
                                            <span>Not Accepted</span>
                                        </label>
                                    </div>
                                    <div class="option-group">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" class="dont-know" data-index="8" <?= (isset($reviews_1->sr_assessment_status) && $reviews_1->sr_assessment_status == 'decide_later') ? 'checked' : ''; ?>>
                                            <span>Decide Later</span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="assessment-item">
                            ...
                            <div class="mt-3">
                                <select class="form-select" name="result" required id="finalResult">
                                    <option value="" <?= empty($reviews_1->sr_review_status) ? 'selected' : '' ?>>-- Select Result --</option>
                                    <?php
                                    $selected = isset($reviews_1) && isset($reviews_1->sr_review_status) ? $reviews_1->sr_review_status : '';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        samcReviewForm.addEventListener('submit', function(e) {
            ...
            document.querySelectorAll(".assessment-item").forEach((item) => {
                const remarksField = item.querySelector("textarea[name^='remarks']");
                const notAcceptedRadio = item.querySelector("input[value='not_accepted']");

                if (notAcceptedRadio && notAcceptedRadio.checked && !remarksField.value.trim()) {
                    isValid = false;
                    remarksField.classList.add("is-invalid");
                } else {
                    // Ensure remarksField exists before removing the class
                    if (remarksField) {
            ...
            if (!isValid) {
                ...
                Swal.fire({
                    ...
                    text: "Please provide remarks for all 'Not Accepted' selections.",
        ...
        // Function to toggle remarks requirement
        function toggleRemarksRequirement() {
            document.querySelectorAll(".assessment-item").forEach((item) => {
                const remarksField = item.querySelector("textarea[name^='remarks']");
                const notAcceptedRadio = item.querySelector("input[value='not_accepted']");

                if (notAcceptedRadio && notAcceptedRadio.checked) {
                    remarksField.setAttribute("required", "required");
                } else {
                    // ✅ Ensure remarksField exists before calling removeAttribute
                    if (remarksField) {
        ...
        document.querySelectorAll('input[type="radio"][name^="status"]').forEach(radio => {
            ...
            radio.addEventListener("change", toggleRemarksRequirement);
        });
    });
</script>