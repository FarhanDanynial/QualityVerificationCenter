                    ...
                    <?php else: ?>
                        <?php foreach ($notifications as $notification): ?>
                            <div class="d-flex mt-2 p-2 <?= ($notification->n_is_read == false || $notification->n_is_read === 'f' || $notification->n_is_read === 0) ? 'bg-light rounded border-start border-primary border-2' : '' ?>">
                                <div>
                                    <div class="icon icon-shape <?= ($notification->n_is_read == false || $notification->n_is_read === 'f' || $notification->n_is_read === 0) ? 'bg-primary' : 'bg-gray-300' ?> shadow-sm text-center border-radius-md" style="width: 32px; height: 32px;">
                                ...
                                <div class="ms-3 w-100">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <?php if ($notification->n_is_read == false || $notification->n_is_read === 'f' || $notification->n_is_read === 0): ?>
                                            <button
                                                class="btn btn-xs text-primary notification-link"
