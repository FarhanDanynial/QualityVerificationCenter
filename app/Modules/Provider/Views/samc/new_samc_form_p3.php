                    ...
                    <div class="col-12 col-lg-12 m-auto">
                        <div class="multisteps-form__form mb-8">
                            ...
                            <div class="card p-3 border-radius-xl js-active" data-animation="FadeIn">
                                <h5 class="font-weight-bolder">Continuous Assessment</h5>
                                <div class="multisteps-form__content">
                                    <form id="step3_form" method="post" action="<?= base_url('provider/samc/save_form/3') ?>">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-center" id="dynamicTable">
                                                <thead class="table-dark bg-gradient-info">
                                                    <tr>
                                                        <th style="border-top-left-radius: 10px;" class="align-middle">Continuos Assessment</th>
                                                        <th style="width:149px;" class="align-middle">Percentage (%)</th>
                                                        <th style="width:171px;" class="align-middle">Guided Instruction</th>
                                                ...
                                                <tbody id="dynamicTableBody">
                                                    <tr id="noticeRow">
                                                        <td colspan="9" class="text-center text-danger">
                                                            ⚠️ Please click "Add Row" to insert a Continuos Assessment.
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let existingData = <?= json_encode($samc_continuous_assessment_data ?? []); ?>;
...
<script>
    $(document).ready(function() {
        $('.js-btn-next').on('click', function(event) {
            ...
            // let csrfTokenName = "<?= csrf_token() ?>"; // CSRF Token Name
            // let csrfHash = "<?= csrf_hash() ?>"; // CSRF Token Hash
        ...
        $('.js-btn-prev').on('click', function(event) {
            ...
            $.ajax({
                url: "<?= base_url('provider/samc/samc_prev_form/3'); ?>",
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function(response) {
