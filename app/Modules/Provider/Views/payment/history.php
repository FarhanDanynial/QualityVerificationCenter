    ...
    <div class="row">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center p-0 pt-3">
                <h2 class="mb-0 fs-4 fw-bold">Payment History</h2>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total SAMC Paid</p>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Invoice Payment</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                RM <?= $invoice_amount ?>
                                            </h5>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total FPX Payment</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                RM <?= $fpx_amount ?>
                                            </h5>
                                        </div>
                                            ...
                                            <td class="text-center">
                                                <div class="action-container justify-content-center">
                                                    ...
                                                    <?php elseif ($invoice->sp_method == 'FPX') : ?>
                                                        ...
                                                        <a href="<?= base_url('provider/fpx/fetch_fpx_receipt_details/' . $invoice->sp_invoice_number) ?>"
                                                            class="btn btn-sm bg-gradient-info action-icon"
                                                            data-bs-toggle="tooltip" title="Invoice Details">
                                                            <i class="fas fa-info-circle" style="font-size: 12px;"></i>
                                                        </a>
