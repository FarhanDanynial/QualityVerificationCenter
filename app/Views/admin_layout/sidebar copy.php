<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#admin_SB_Section" class="nav-link " aria-controls="admin_SB_Section" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
        ...
        <div class="collapse " id="admin_SB_Section">
          <ul class="nav ms-4 ps-3">
            <!-- <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/assessors_list">
                <span class="sidenav-mini-icon"> A </span>
                <span class="sidenav-normal"> Assessors <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/providers_list">
                <span class="sidenav-mini-icon"> P </span>
                <span class="sidenav-normal"> Providers <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/course_list">
                <span class="sidenav-mini-icon"> C </span>
                <span class="sidenav-normal"> Course <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/samc_monitoring">
                <span class="sidenav-mini-icon"> M </span>
                <span class="sidenav-normal"> Monitoring <b class="caret"></b></span>
              </a>
            </li> -->
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/samc/samc_management">
                <span class="sidenav-mini-icon"> M </span>
                <span class="sidenav-normal"> SAMC Management <b class="caret"></b></span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>qvcAdmin/invoice/invoice_management">
