...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html " target="_blank">
      ...
      <span class="ms-1 font-weight-bold">APP MPQUA</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#accountSB" class="nav-link <?= $current == 'appmpqua/profile' ? 'active' : '' ?>" aria-controls="accountSB" role="button" aria-expanded="false">
        ...
        <div class="collapse <?= strpos($current, 'appmpqua/profile') !== false ? 'show' : '' ?>" id="accountSB">
          <ul class="nav ms-4 ps-3">
            <!-- <li class="nav-item active"> -->
            <li class="nav-item ">
              <!-- <a class="nav-link active" href="<?= base_url() ?>pages/dashboards/default.html"> -->
              <a class="nav-link <?= strpos($current, 'appmpqua/profile') !== false ? 'active' : '' ?>"  href="<?= base_url() ?>appmpqua/profile">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#appmpqua_SB_Section" class="nav-link  <?= strpos($current, 'appmpqua/viewAll') !== false ||  strpos($current, 'appmpqua/viewUni') !== false? 'active' : '' ?>" aria-controls="assessors_SB_Section" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          ...
          <span class="nav-link-text ms-1">App MPQUA</span>
        </a>
        <div class="collapse <?= strpos($current, 'appmpqua/viewAll') !== false ||  strpos($current, 'appmpqua/viewUni') !== false? 'show' : '' ?>" id="appmpqua_SB_Section">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item ">
              <a class="nav-link  <?= strpos($current, 'appmpqua/viewAll') !== false ? 'active' : '' ?>" href="<?= base_url() ?>appmpqua/viewAll">
                <span class="sidenav-mini-icon"> All </span>
                <span class="sidenav-normal">List: All</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link <?= strpos($current, 'appmpqua/viewUni') !== false ? 'active' : '' ?>" href="<?= base_url() ?>appmpqua/viewUni">
                <span class="sidenav-mini-icon"> Uni </span>
                <span class="sidenav-normal">List: <?= get_university_name(session()->get('mpq_qu_id')) ?></span>
              </a>
            </li>
          </ul>
        </div>
